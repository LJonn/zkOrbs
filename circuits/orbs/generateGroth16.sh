...
snarkjs zkey contribute ${CIRCUIT}_0000.zkey ${CIRCUIT}_final.zkey --name="zkOrbsContribution1" -v -e="thisShouldBeChangedAndSecretLul"
snarkjs zkey contribute ${CIRCUIT}_0000.zkey ${CIRCUIT}_final.zkey --name="zkOrbsContribution2" -v
...
snarkjs groth16 fullprove input.json ${CIRCUIT}_js/${CIRCUIT}.wasm ${CIRCUIT}_final.zkey proof.json public.json
